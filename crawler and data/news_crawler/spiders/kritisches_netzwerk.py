...
class KritischesNetzwerk(BaseSpider):
    ...
    rules = (
        Rule(
            LinkExtractor(
                ...
                deny=(
                    r"kritisches-netzwerk\.de\/content\/",
    ...
    def parse_item(self, response):
        ...
        paragraphs = [
            ...
            for node in response.xpath('//p[@class="rtejustify"]')
        ]
        ...
        news_keywords = response.xpath(
            '//div[@class="field field-name-field-tags field-type-taxonomy-term-reference field-label-inline clearfix"]//a/text()'
        ).getall()
